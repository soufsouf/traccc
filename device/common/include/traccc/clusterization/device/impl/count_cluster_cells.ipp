...
inline void count_cluster_cells(
 ...
 printf(" hello 1 %llu , hello 2 %u , prefix sum %llu ,module_idx %u,  device_cluster_prefix_sum[]: %llu  \n",n_clusters,cindex,prefix_sum, module_idx,device_cluster_prefix_sum[module_idx] );
